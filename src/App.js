...
import { createPostAction, SetSelectedShapeList, SetSelectedColorList, SearchResult, SetSelectedSearchText,setOperation  } from './Actions/index';
...
const App = ()=>{
  ...
  function onSearch(value){
    ...
    dispatch(setOperation(value));//sending this for the url setting.
    setSearchText(value); 
  }
  const { Search } = Input; 
  let colorList = [];
  ...
  function onChangeColor(checkedValues) { 
    ...
    dispatch(setOperation(checkedValues));//sending this for the url setting.
